...
Route::group(['middleware' => 'api'], function ($router) {
    ...
    Route::post('/medicos/{id_medico}/pacientes', [MedicoController::class, 'bindPatient']);
    ...
    Route::get('/medicos/{id_medico}/pacientes', [PacienteController::class, 'getPatinentByDoctor']);
